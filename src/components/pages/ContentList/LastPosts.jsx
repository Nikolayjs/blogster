        ...
        <>
          <section className="px-2 lg:flex lg:space-x-2">
            ...
            >
              ...
              />
              <div className="p-4 absolute bottom-0 left-0 z-20">
                <h2 className="text-4xl font-semibold text-gray-100 leading-tight">Заголовок</h2>

                <div className="flex mt-3">
                  <img className="h-10 w-10 rounded-full mr-2 object-cover" src={``} alt="author" />
                  <div>
                    <p className="font-semibold text-gray-200 text-sm"></p>
                    <time className="text-gray-400 text-xs"></time>
                  </div>
                </div>
              </div>
            </Link>
